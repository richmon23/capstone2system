...
<body>
    <div class="row">
        ...
        <form id="signupForm" method="POST" action="register.php" enctype="multipart/form-data">
                ...
                <div class="profile-pic">
                    ...
                    <div class="profile-container">
                        ...
                        <input type="file" id="profile_pic" name="profile_pic" accept="image/*" required style="display: none;">
                    </div>
                </div>
                <center>
                    <button type="button" id="openTermsBtn" class="sign-up" disabled>Sign Up</button>
                </center>
               <center> <span class="account">Have an account? <a href="userlogin.php" class="signuplogin">Login</a></span></center>
            </form>
            <br>
        </div>      
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>1. Acceptance of Terms </h4><br>
                ...
                <br><br>
                <h4>2. System Usage The Memorial Park Management</h4><br>is designed to manage and provide services related to memorial park plots, reservations, customer support, and administrative tasks. You agree to use the system only for lawful purposes.
                ...
                <br><br>
                <h4>3. Reservations for plots and services</h4><br>must be made through the system. You are responsible for providing accurate information when making a reservation. Incomplete or incorrect information may lead to reservation delays or cancellations.
                ...
                <br><br>
                <h4>4. Payments The system supports</h4><br>both online and cash payment methods. All payment transactions must be completed through the methods provided in the system.
                ...
                <br><br>
                <h4>5. Information and Privacy</h4><br>
                ...
                <br><br>
                <h4>6. Penalties for Violations</h4><br>
                ...
                <br><br>
                <h4>9. Non-Refundable Policy</h4><br>
                ...
                <br><br>
                <h4>10. System Access and Availability</h4><br>
                ...
                <br><br>
                <h4>11. Account Suspension and Termination</h4><br>
                ...
                <br><br>
                <h4>11. Dispute Resolution</h4><br>
                ...
                <br><br>
                <h4>12. Changes to Terms and Conditions</h4><br>
    ...
    // TODO: add file functionality for image upload
